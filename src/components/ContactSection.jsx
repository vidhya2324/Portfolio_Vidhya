...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://formspree.io/f/mdkgvjlb", {
      method: "POST",
      body: formData,
      headers: {
    ...
    if (response.ok) {
      toast({
        title: "Message Sent!",
        description: "Got your message—will follow up shortly!",
        duration: 3000,
      });
      e.target.reset();
    } else {
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:vidhyabtech22@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    vidhyabtech22@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a
                  href="https://www.linkedin.com/in/vidhya-s2324"
                  target="_blank"
                ...
                <a
                  href="https://discord.com/users/1218242864438448211"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaDiscord size={24} />
